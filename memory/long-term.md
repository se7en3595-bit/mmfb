...
### 分屏预览修复
- **根因**：`_load_file_in_view()` (window.py 第 447-449 行) 原本只显示静态 HTML 占位符 "Bridge not connected"，没有利用子 view 已注入的 QWebChannel
